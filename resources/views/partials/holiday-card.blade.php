<div class="relative rounded-2xl overflow-hidden shadow-md col-span-1 sm:col-span-2 min-h-[140px] flex items-end"
    ...
    <div class="relative z-10 p-5 w-full">
        <div class="flex items-end justify-between">
            <div>
                ...
                <h3 class="text-white font-serif font-bold text-2xl leading-tight">
                    {{ $holiday['name'] }}
                </h3>
